        ...
        :(<div className='p-4 sm:p-6 rounded-lg border'>
            ...
            <div className="flex flex-col sm:flex-row justify-between mb-8">
                ...
                <div className="flex flex-col items-start sm:items-end mt-4 sm:mt-0">
                    <span className={`${orderDetails.isPaid ?"bg-green-100 text-green-700":"bg-red-100 text-red-700" } text-sm px-3 py-1 rounded-full mb-2 font-medium`}>
                        {orderDetails.isPaid ? "Approved":"Pending"}
                    </span>
                    <span className={`${orderDetails.isDelivered ?"bg-green-100 text-green-700":"bg-yellow-100 text-yellow-700" } text-sm px-3 py-1 rounded-full mb-2 font-medium`}>
                        {orderDetails.isDelivered ? "Delivered":"Pending"}
                    </span>
                </div>
            </div>
            {/* Customer , payment and shipping info */}
            <div className="grid grid-col-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
                <div>
